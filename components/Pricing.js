  ...
  return (
    <div className="bg-gradient-to-b from-white-300 to-white-500 w-full pt-20 mb-2" id="pricing">
      <div className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto flex flex-col w-full text-center justify-center">
        ...
        {/* BOX */}
        <div className="flex flex-col sm:flex-row items-center justify-center mt-5 space-y-10 sm:space-y-0 sm:space-x-10">
          {[1, 2].map((_, index) => (
              ...
              >
                ...
                <div className="px-5 pb-5">
                  ...
                  <div className="flex items-center justify-between pt-2">
                    ...
                    <a href="#" className="text-white-500 bg-maroon-500 hover:bg-maroon-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2.5 text-center">
                      Beli
                    </a>
                  </div>
                </div>
